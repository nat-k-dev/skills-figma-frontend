...
3. Select the manifest file at:
   `<project-root>/figma-desktop-bridge/manifest.json`
4. Go to **Plugins → Development → Figma Desktop Bridge**
5. Click to run it — a panel appears showing **"MCP ready"**
6. Keep the panel open while using the MCP server
